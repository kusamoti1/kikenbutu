...
LAW_KEYWORDS = {
    ...
    "消防法施行令": r"(?:消防法|(?<![a-zA-Zぁ-んァ-ヶ一-龥]))施行令\s*第?([0-9一二三四五六七八九十百]+条(?:の[0-9一二三四五六七八九十]+)?(?:\s*第[0-9一二三四五六七八九十]+項)?(?:\s*第?[0-9一二三四五六七八九十]+号)?)",
    "消防法施行規則": r"(?:消防法|(?<![a-zA-Zぁ-んァ-ヶ一-龥]))施行規則\s*第?([0-9一二三四五六七八九十百]+条(?:の[0-9一二三四五六七八九十]+)?(?:\s*第[0-9一二三四五六七八九十]+項)?(?:\s*第?[0-9一二三四五六七八九十]+号)?)",
